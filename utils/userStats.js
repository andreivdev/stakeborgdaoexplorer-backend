var standard_token_abi = require("./../abi/standard_token.json");
var governance_staking_abi = require("./../abi/governance_staking.json");
var governance_rewards_abi = require("./../abi/governance_rewards.json");
var yieldfarmtoken_bond_abi = require("./../abi/yieldfarmtoken_bond.json");
var yieldfarmtoken_swingby_abi = require("./../abi/yieldfarmtoken_swingby.json");
var yieldfarmtoken_xyz_abi = require("./../abi/yieldfarmtoken_xyz.json");
var yieldfarmtoken_usdc_lp_abi = require("./../abi/yieldfarmtoken_usdc_lp.json");
...
async function getGovernanceStakedTokens(addr) {
  if (!web3.utils.isAddress(addr)) return 0;
  let govstake = 0;
...
async function getGovernanceUnclaimedTokens(addr) {
  if (!web3.utils.isAddress(addr)) return 0;
...
async function getFarmingUnclaimedTokens(addr) {
  if (!web3.utils.isAddress(addr)) return 0;
...
async function getAllHoldersData() {
  await init();
  let data = [];
